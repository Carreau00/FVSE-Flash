...
package Shared.AS3
{
    ...
    public dynamic class BSUIComponent extends MovieClip 
    {
        ...
        public function set bShowBrackets(_arg1:Boolean)
        {
            if (this.bShowBrackets != _arg1)
            {
                this._bShowBrackets = _arg1;
                this.SetIsDirty();
            };
        }
        ...
        public function set bracketLineWidth(_arg1:Number):void
        {
            if (this._bracketLineWidth != _arg1)
            {
                this._bracketLineWidth = _arg1;
                this.SetIsDirty();
            };
        }
        ...
        public function set bracketCornerLength(_arg1:Number):void
        {
            if (this._bracketCornerLength != _arg1)
            {
                this._bracketCornerLength = _arg1;
                this.SetIsDirty();
            };
        }
        ...
        public function set bracketPaddingX(_arg1:Number):void
        {
            if (this._bracketPaddingX != _arg1)
            {
                this._bracketPaddingX = _arg1;
                this.SetIsDirty();
            };
        }
        ...
        public function set bracketPaddingY(_arg1:Number):void
        {
            if (this._bracketPaddingY != _arg1)
            {
                this._bracketPaddingY = _arg1;
                this.SetIsDirty();
            };
        }
        ...
        public function set BracketStyle(_arg1:String)
        {
            if (this._bracketStyle != _arg1)
            {
                this._bracketStyle = _arg1;
                this.SetIsDirty();
            };
        }
        ...
        public function set bUseShadedBackground(_arg1:Boolean)
        {
            if (this._bUseShadedBackground != _arg1)
            {
                this._bUseShadedBackground = _arg1;
                this.SetIsDirty();
            };
        }
        ...
        public function set ShadedBackgroundType(_arg1:String)
        {
            if (this._shadedBackgroundType != _arg1)
            {
                this._shadedBackgroundType = _arg1;
                this.SetIsDirty();
            };
        }
        ...
        public function set ShadedBackgroundMethod(_arg1:String)
        {
            if (this._shadedBackgroundMethod != _arg1)
            {
                this._shadedBackgroundMethod = _arg1;
                this.SetIsDirty();
            };
        }
        ...
        final private function onEnterFrameEvent(_arg1:Event):void
        {
        ...
        final private function onAddedToStageEvent(_arg1:Event):void
        {
        ...
        final private function onRemovedFromStageEvent(_arg1:Event):void
        {
        ...
        final private function onSetPlatformEvent(_arg1:Event)
        {
            var _local2:PlatformChangeEvent = (_arg1 as PlatformChangeEvent);
            this.SetPlatform(_local2.uiPlatform, _local2.bPS3Switch);
        }

        public function UpdateBrackets(_arg1:Boolean)
        {
        ...
        public function SetPlatform(_arg1:Number, _arg2:Boolean):void
        {
            if (((!((this._iPlatform == _arg1))) || (!((this._bPS3Switch == _arg2)))))
            {
                this._iPlatform = _arg1;
                this._bPS3Switch = _arg2;
                this.SetIsDirty();
            };
        }
