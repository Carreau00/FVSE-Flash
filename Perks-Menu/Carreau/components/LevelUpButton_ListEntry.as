package Carreau.components {
	...
	public class LevelUpButton_ListEntry extends BSScrollingListEntry {
		
		
		public function LevelUpButton_ListEntry() {
			// constructor code
		...
		override public function SetEntryText(param1:Object, param2:String) : *
		{
			...
			if(param1.disabled)	//Main menu shows this as param1.disabled
			{
